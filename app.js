...
function openChangePw() {
  ...
  if (sub) {
    sub.textContent = currentUser.email === 'admin@ejaari.local'
      ? 'سيتم إرسال تأكيد التغيير إلى: johnjohan10499@gmail.com'
...
function handleChangePw() {
  ...
  if (currentUser.email === 'admin@ejaari.local') {
    ...
    console.log(`[EMAIL] To: johnjohan10499@gmail.com | Subject: تغيير كلمة مرور الأدمين | New password changed for admin@ejaari.local`);
